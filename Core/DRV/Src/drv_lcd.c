#include "../Inc/drv_lcd.h"
#include "lcd_fonts.h"
#include "stdio.h"
#include "spi.h"

// 将硬编码的LCD_SPI替换为可配置的SPI句柄
static SPI_HandleTypeDef* lcd_spi_handle = NULL;
...
// 以下进行一些驱动的默认设置
   ...
   LCD_SetAsciiFont(&ASCII_Font16);       // 设置默认字体
...
{  
	...
	if( LCD.ShowNum_Mode == Fill_Space)	// 多余位补0
	{
